...
export default function ActivityList({ activities, dispatch }: ActivityListProps) {
    ...
    return (
        <>
            <h2 className="text-4xl text-center font-bold text-slate-600">Comida y Actividades</h2>

            {isEmptyActivities ? (
                <p className="my-5 text-center">No hay actividades</p>
            ) : 
                activities.map( activity => (
                    <div key={activity.id} className="py-5 px-10 bg-white mt-5 flex justify-between shadow">
